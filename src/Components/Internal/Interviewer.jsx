    ...
    <div className=' w-full h-full flex flex-col items-center font-[Roboto] ' >
      ...
      <div className='w-full flex pt-[12px] pb-[12px] pr-2 justify-end gap-[60px] ' >
        <div className='w-[446px] h-[40px] flex justify-around items-center border-2 rounded-[28px] pr-1 pl-1 ' >
          <input className='  w-[358px] h-[37px] ml-1  text-[#979DA3] border-none focus:outline-none ' type="text" placeholder='Search job by Name, Email & Mobile Number' />
          <button>
...

      {
        addUser && (
          <div className='h-full w-full fixed inset-0 flex items-center justify-center font-[Roboto] bg-black bg-opacity-50 z-50 ' >
            <div className=' w-[705px] h-[562px] flex flex-col justify-center items-center bg-[#FFFFFF] ' >
              <div className='w-full flex justify-center items-center  ' >
                <table className=' w-[90%] flex flex-col justify-center items-center ' >
                  <div>
                    <tbody className='flex flex-col justify-center items-end text-[#6B6F7B] ' >
                      <tr className='flex justify-between items-center gap-2 p-1 ' >
                        <td className='font-semibold' >Name</td>
                        <td className='' ><input
                          type="text"

                          placeholder="TargetHR"
                          className="w-[360px] h-[32px] p-3 text-center border rounded-md text-black focus:outline-none focus:ring-2 focus:ring-blue-500 border-[#CAC4D0] "
                        /></td>
                      </tr>
                      <tr className='flex justify-between items-center gap-2 p-1 ' >
                      ...
                      <tr className='flex justify-between items-center gap-2 p-1 ' >
                        ...
                        <td className='' ><input
                          ...
                          className="w-[360px] h-[32px] p-3 text-black text-center border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 border-[#CAC4D0]"
                        /></td>
                      </tr>
                      <tr className='flex justify-between items-center gap-2 p-1 ' >
                        <td className='font-semibold' >Current Company</td>
                        <td className='' ><input
                          type="text"
                      ...
                      <tr className='flex justify-between items-center gap-2 p-1 ' >
                        <td className='font-semibold' >Job Assigned</td>
                        <td className='' >
                          <select
                  ...
                  <div className='w-[90%] flex flex-col justify-end items-end pr-2 pl-2  ' >
