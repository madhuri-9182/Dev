...
function Clients() {
  ...
  return (
    <div className="px-6">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="View Client Details" className='w-[500px] max-h-[75vh] top-auto'>
        ...
        <div className="flex justify-end mt-4">
          <button className='primary-button' onClick={handleEditClick} >Edit <Edit sx={{ fontSize: 16, paddingBottom: '2px', paddingLeft: '2px' }} /></button>
        </div>
      </Modal>
    </div>
  );
