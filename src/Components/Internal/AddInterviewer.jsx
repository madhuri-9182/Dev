              ...
              <li className="flex items-center gap-x-4 justify-start  ">
                ...
                <div className="w-1/2">
                  <RolesSelect
                    ...
                    className="max-w-[140px] h-[32px] text-[12px]"
            ...
            <li className="flex items-center justify-start gap-x-4 ">
              ...
              <div className="w-1/2">
                <select
                  ...
                  className={`w-[140px] h-[32px] text-center text-black border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[12px] border-[#CAC4D0] ${
                    selectedStrength === ""
                      ? "text-gray-500"
                      : "text-black"
                  }`}
                ...
                <div className="w-1/2">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M136.5 36.0001L136.5 24.6201"
                        stroke="#171717"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M139.85 26.85L136.5 23.5L133.15 26.85"
                        stroke="#171717"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
