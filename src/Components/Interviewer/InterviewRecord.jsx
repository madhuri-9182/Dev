  ...
  return (
    <div className='flex h-full'>
      <div className='w-5/6 h-screen p-2'>
        <div className='p-4'>
          <div> <h1 className='text-[18px] font-bold'>Accepted Interviews <span className='text-white bg-[#056DDC] px-2 py-1 rounded-full'>38</span></h1></div>
          <div className="p-4">
                  ...
                  <tr key={index} className="my-[2px]">
                    <td colSpan="8" className="p-0">
                      ...
                      <div className="bg-[#EBEBEB] rounded-full flex items-center justify-between px-4 py-3 text-sm">
                        <span className="flex-1 px-4">{item.name}</span>
                        <span className="flex-1 px-4">{item.role}</span>
                        <span className="flex-1 px-4">{item.function}</span>
                        <span className="flex-1 px-4">{item.date}</span>
                        <span className="flex-1 px-4">{item.time}</span>
                        <span className="flex-1 px-4">{item.experience}</span>
                        <span className="flex-1 px-4">{item.company}</span>
                        <span className="flex items-center gap-4 px-4">
                          ...
                          <button className="text-gray-500 hover:text-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#434343"><path d="m424-312 282-282-56-56-226 226-114-114-56 56 170 170ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z" /></svg>
                          </button>
                          <button className="text-gray-500 hover:text-red-500"  ><Link to={'/interviewer/feedback'} >
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#434343"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z" /></svg></Link>
                          </button>
                          <button className="text-gray-500 hover:text-red-500">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#434343"><path d="M507-480 384-357l56 57 180-180-180-180-56 57 123 123ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg>
                          </button>
                        </span>
                      </div>
                    </td>
        ...
        <div className='p-4'>
          <div> <h1 className='text-[18px] font-bold'>Pending Feedback <span className='text-white bg-[#056DDC] px-2 py-1 rounded-full'>25</span></h1></div>
          <div className="p-4">
            <table className="w-full rounded-lg border-separate border-spacing-y-[2px]">
              <thead>
                <tr className=" text-black text-sm font-semibold">
        ...
        <div className='p-4'>
          <div> <h1 className='text-[18px] font-bold'>Interview History<span className='text-white bg-[#056DDC] px-2 py-1 rounded-full'>12</span></h1></div>
          <div className="p-4">
            <table className="w-full rounded-lg border-separate border-spacing-y-[2px]">
              <thead>
                <tr className=" text-black text-sm font-semibold">
      ...
      <div className='flex items-start justify-center w-1/6 py-5 px-4 h-screen'>
        <div className='p-5 mt-20 flex flex-col  items-center justify-start rounded-lg w-full bg-[#E7E4E8] h-2/4'>
          ...
          className=' border border-purple-950 px-5 py-2 w-11/12 rounded-full text-xl text-center'> Check Receivables</Link>
          <Link
          to='/hiring-dog/interviewer/calendar' 
