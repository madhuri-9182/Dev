...
function Analytics() {
  ...
  const [selectedDateFrom, setSelectedDateFrom] =
    React.useState(null);
  const [showCalendarFrom, setShowCalendarFrom] =
  ...
  const [selectedDateTo, setSelectedDateTo] =
    React.useState(null);
  const [showCalendarTo, setShowCalendarTo] =
    React.useState(false);
                                ...
                                <DateCalendar
                                  ...
                                  sx={{
                                    ...
                                    "& .MuiPickersYear-yearButton.Mui-selected":
                                      {
                                        backgroundColor:
                                          "#65558f", // Change the background color to red
                                      },
                                  }}
                                />
                              </div>
              ...
              >
                ...
                <div className="flex space-x-2">
                  ...
                  <div className="w-[101px] h-[24px] border border-[#79747E] rounded-full text-[12px] flex items-center justify-evenly  hover:scale-105 hover:duration-150">
                    ...
                    <div className="text-[#65558F] font-bold hover:cursor-pointer">
                      Download
                    </div>
                  </div>
                </div>
