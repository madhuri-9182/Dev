...
function AnalyticsDateFilter() {
  ...
  const { dateFrom, dateTo, jobFilter } =
    location.state || {};
            ...
            <div className="w-[40%]">
              <div className="space-y-2 mt-1">
                ...
                <div className="flex items-center space-x-1">
                  <span className="text-sm font-bold mr-2 flex">
                    Jobs
                  </span>
                  {jobs.map((jobs) => (
                    <button
                ...
                <div className="mt-4 space-y-4">
                  {[
                    ...
                    >
                      ...
                      <div className=" bg-[#979797] text-white w-[32px] h-[32px] rounded-full flex items-center justify-center">
                        {value}
                      </div>
                    </div>
                  ))}
                ...
                <div className="w-[280px]">
                  ...
                  <div className="">
                    {[
                      ...
                      ([company, percentage], index) => (
                        <div>
                          <div
                            key={index}
                            className={`w-full h-[91px] p-3 pr-[25%] flex items-center justify-between ${
                              index % 2 === 0
                                ? "bg-white"
                                : "bg-[#FFFBEB]"
                            }`}
              ...
              <div className="">
                ...
                <div className="space-y-4">
                  <div className="w-[200px] h-[96px] bg-[#E5ECF6] p-4 rounded-xl text-gray-600">
                    ...
                    <p className="text-2xl text-[#1C1C1C] font-bold">
                      1:28
                    </p>
                  </div>
                  <div className="w-[200px] h-[96px] bg-[#E5ECF6] p-4 rounded-xl text-gray-600">
                    <p className="text-[#1C1C1C] text-sm">
                      Selection Ratio for Diversity
                    </p>
                    <p className="text-2xl text-[#1C1C1C] font-bold">
                      1:6
                    </p>
