const styles = {
  shadow1: {
    boxShadow:
      "0 0px 6px #c1c1c1, 0 -0px 0px #c1c1c1, 0px 0 0px #c1c1c1, -0px 0 6px #c1c1c1",
  },
};
        ...
        <div className="ml-[5%]">
          <div className="pendingTaskHeading">
            <h1 className="text-[18px] font-semibold text-[#333B69]">
              Pending Task{" "}
              <span className="text-white text-sm font-normal bg-[#056DDC] px-2 py-2 rounded-full">
                38
              </span>
            </h1>
          </div>
          <div className="pendingTaskBox mt-5">
            <div
              className="p-6 bg-[#E7E4E8] rounded-xl w-[400px] h-[246px] transition ease-linear delay-150 hover:-translate-y-0 hover:scale-110 "
      ...
      <div className="pendingTaskContainer p-4 w-full flex flex-col ">
        <div className="ml-[5%] flex-grow flex flex-col">
          ...
          <div className="pendingTaskBox mt-5 ">
            <div
              style={styles.shadow1}
              className="p-6 bg-gradient-to-r from-blue-600 to-blue-300 rounded-xl w-[400px] h-[170px] transition ease-linear delay-150 hover:-translate-y-0 hover:scale-110"
            >
