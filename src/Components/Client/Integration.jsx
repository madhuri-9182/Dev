            ...
            <div className="flex  ">
              ...
              <div className="flex flex-col p-2 pl-0 gap-y-2">
                ...
                <ul className=" pl-6 list-disc text-gray-500 text-[14px] ">
                  <li>
                    Slack integrations helps you to get
                    latest hiring updates.
                  </li>
                  <li>
                    Channel notifications can be turned
                    ON/OFF based on your preferences.{" "}
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div>
          <div className="flex flex-col p-2 pl-0 pr-14 gap-y-2 bg-green-50 ">
            <div className=" flex items-center  gap-2 text-[14px] ">
              ...
              <span>
                In case you get notified with &quot;
                <Link className="text-[#006eff] font-medium ">
                  Request to Install
                </Link>
                &quot; message during{" "}
                <Link className="text-[#006eff] font-medium ">
            ...
            <ul className=" pl-8 list-disc  text-[14px] ">
              <li>
                Submit the app approval request and ask your{" "}
                <Link className="text-[#006eff] font-medium ">
                  Workspace Owner
                </Link>{" "}
                to approve the app (Owner will recieve a
                message by SlackBot - click{" "}
                <Link className="text-[#006eff] font-medium ">
                  Approve for Workspace
                </Link>
                ). Once approved, try again.{" "}
              </li>
            </ul>
          </div>
          <hr className="mt-4" />
            ...
            <div className="flex  ">
              <div className=" flex items-start p-0">
                <svg
                  ...
                  width="64"
                  height="64"
                  viewBox="0 0 562.000000 561.000000"
                ...
                >
                  ...
                  >
                    <path
                      d="M3350 4941 c-52 -17 -89 -42 -128 -86 -53 -61 -69 -125 -53 -217 16
              ...
              <div className="flex flex-col p-2 pl-0 gap-y-2">
                ...
                <ul className=" pl-6 list-disc text-gray-500 text-[14px] ">
                  <li>
                    The Greenhouse-BarRaiser integration
                    allows you to seamlessly upload the
                    candidate details to the BarRaiser
                    system and extract/retrieve the
                    BarRaiser Global Scorecard (BGS) from
                    BarRaiser to Greenhouse.
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div>
          <div className="flex flex-col p-2 pl-0 pr-14 gap-y-2 bg-green-50 ">
            ...
            <ul className=" pl-8 list-disc  text-[14px] ">
              <li>
                {" "}
                Please refer to the detailed integration
                document -
                <Link className="text-[#006eff] font-medium ">
                  {" "}
        ...
        <div className="flex justify-between gap-4 ">
          <div className="flex gap-[14PX]  ">
            ...
            <div className="flex flex-col p-2 pl-0 gap-y-2">
              ...
              <ul className=" pl-6 list-disc text-gray-500 text-[14px] ">
                <li>
                  The Lever-BarRaiser integration allows you
                  to seamlessly upload the candidate to the
                  BarRaiser system and get the BarRaiser
                  Global Scorecard (BGS) from BarRaiser to
                  Lever.
                </li>
              </ul>
            </div>
