...
function ClientScheduleInterview() {
  ...
  const item = stateData
    ? JSON.parse(decodeURIComponent(stateData))
    : null;
    ...
    <div className="w-full flex gap-x-3">
        ...
        <div className=" p-8 flex flex-col gap-y-4">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-[16px] text-[#6B6F7B]">
          ...
          <div className="flex flex-col items-start">
            ...
            <button className="text-[16px]  text-[#056DDC] hover:underline">
              Download
            </button>
          </div>
          <div className="flex flex-col">
      ...
      <div className="w-full p-6">
        ...
        <div className="mt-8 flex items-center justify-end gap-x-4">
          <button
            className="text-sm border border-[#79747E] text-[#65558F] w-[143px] h-[40px] rounded-full"
            onClick={() => navigate("/agency/candidates")}
          >
            Drop Candidate
          </button>
          <button
            className="text-sm bg-[#E8DEF8] text-[#4A4459] w-[143px] h-[40px] rounded-full"
            onClick={() => navigate("/agency/candidates")}
          >
            Schedule Later
          </button>
          <button
            className="text-sm bg-[#007AFF]  text-white w-[143px] h-[40px] rounded-full"
            onClick={() => navigate("/agency/candidates")}
          >
            Confirm
          </button>
